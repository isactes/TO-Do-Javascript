 ...
 */
export function preparationTimeInMinutes(PREPARATION_MINUTES_PER_LAYER) {
  return PREPARATION_MINUTES_PER_LAYER * EXPECTED_MINUTES_IN_OVEN;
}
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  return preparationTimeInMinutes(PREPARATION_MINUTES_PER_LAYER)  * actualMinutesInOven;