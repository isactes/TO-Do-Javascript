...
function Navbar({ toggleSideNav }) {
  return (
    <>
      <nav
        className="relative flex w-full flex-wrap items-center justify-between bg-[#1a1a1a] py-2 text-neutral-500 shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:bg-neutral-600 lg:py-4"
        data-te-navbar-ref
      >
